 ...
 * 
 * @param {Function} validationFn - Function to validate data
 ...
 */
export const createValidator = (validationFn, contextName) => {
  /**
  ...
  return (data, options = {}) => {
    ...
    try {
      ...
      const formattedErrors = error.message || 'Validation failed';
